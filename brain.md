...
- Admin assigns Nadiya/Mahfuz dynamic designations and responsibility notes on the shared Team page; identity roles and approval logic remain unchanged. Admin can edit/delete requests, investments, finance records, products, categories, and tasks; product edits include stock quantity and buy price with ledger adjustment, while category deletion protects products and product deletion removes its sales history.
