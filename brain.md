...
- Admin assigns Nadiya/Mahfuz dynamic designations and responsibility notes on the shared Team page; identity roles and approval logic remain unchanged. Admin can also edit all request/investment records, product details, and any shared task's full details; stock quantities and sales history remain ledger-backed.
